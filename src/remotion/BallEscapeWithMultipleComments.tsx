 ...
 */
export const BallEscapeWithMultipleComments: React.FC<
  BallEscapeWithMultipleCommentsProps
> = ({ commentCount = 1, commentDelay = 120, autoGenerate = true }) => {
  ...
  const commentTimings = Array.from(
    { length: Math.min(commentCount, 4) },
    (_, i) => ({
  ...
  return (
    <AbsoluteFill>
      ...
      {commentCount > 1 &&
        ...
        Array.from({ length: commentCount - 1 }, (_, i) => (
          <TikTokComment
      ...
      {mainComment.username && mainComment.comment && (
        ...
        >
          ...
          <div
            style={{ marginTop: "4px", fontSize: "10px", lineHeight: "1.3" }}
          >
