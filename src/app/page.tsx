...
export default function Home() {
  const { isGenerating, isSuccess, error, commentData, regenerate } =
              ...
              {isGenerating && (
                <>
                  ...
                  <span className="text-white font-medium">
                    Génération du commentaire TikTok...
                  </span>
                </>
              )}
      ...
      <div className="mt-8 max-w-3xl text-gray-300 space-y-4">
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li className="text-blue-400 font-medium">
            💡 Un nouveau commentaire TikTok est généré automatiquement à chaque
            chargement !
          </li>
        </ul>
